...
export class SyncswapRouter__factory {
  static readonly abi = _abi;
  static createInterface(): SyncswapRouterInterface {
    return new Interface(_abi) as SyncswapRouterInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SyncswapRouter {
    return new Contract(address, _abi, runner) as unknown as SyncswapRouter;
  }
}
