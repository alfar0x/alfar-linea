...
import type { LineaBankCore, LineaBankCoreInterface } from "../LineaBankCore";
...
export class LineaBankCore__factory {
  static readonly abi = _abi;
  static createInterface(): LineaBankCoreInterface {
    return new Interface(_abi) as LineaBankCoreInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LineaBankCore {
    return new Contract(address, _abi, runner) as unknown as LineaBankCore;
  }
}
