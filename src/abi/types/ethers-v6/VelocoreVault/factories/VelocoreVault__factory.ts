...
import type { VelocoreVault, VelocoreVaultInterface } from "../VelocoreVault";
...
export class VelocoreVault__factory {
  static readonly abi = _abi;
  static createInterface(): VelocoreVaultInterface {
    return new Interface(_abi) as VelocoreVaultInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): VelocoreVault {
    return new Contract(address, _abi, runner) as unknown as VelocoreVault;
  }
}
